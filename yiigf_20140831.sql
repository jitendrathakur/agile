...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2014 at 10:03 PM
...
(7, 'districts_index', NULL, NULL),
(8, 'districts_create', NULL, NULL);
...
(1, 1, 'skX2K3uW9sAGjHprC8ETqpScLXi0Lrl8', 1, '2014-05-03 00:09:31', '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(2, 2, 'Nb5E8C1mm1EL30ISMiNSMEOORTxjXbPZ', 1, '2014-05-10 00:15:25', '2014-05-10 00:15:25', '2014-05-10 00:15:25');
...
INSERT INTO `attributes` (`id`, `namespace`, `slug`, `name`, `description`, `type`, `options`, `validation`, `enabled`, `created_at`, `updated_at`) VALUES
(1, 'platform/pages', 'meta_title', 'Meta Title', NULL, 'input', NULL, NULL, 1, '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(2, 'platform/pages', 'meta_description', 'Meta Description', NULL, 'input', NULL, NULL, 1, '2014-05-03 00:09:31', '2014-05-03 00:09:31');
...
(1, 1, 'Platform\\Pages\\Models\\Page', 1, 'Welcome', '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(2, 2, 'Platform\\Pages\\Models\\Page', 1, 'The default home page.', '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(3, 1, 'Platform\\Pages\\Models\\Page', 2, '', '2014-05-03 00:50:26', '2014-05-03 00:50:26'),
(4, 2, 'Platform\\Pages\\Models\\Page', 2, '', '2014-05-03 00:50:26', '2014-05-03 00:50:26');

-- --------------------------------------------------------

--
-- Table structure for table `billingreports`
--

CREATE TABLE IF NOT EXISTS `billingreports` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `billto_districtname` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `billto_attn` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `billto_address` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `billto_city` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `billto_state` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `billto_zipcode` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nbcot` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `config` (
  ...
  UNIQUE KEY `config_environment_group_namespace_item_unique` (`environment`,`group`,`namespace`,`item`)
...
INSERT INTO `config` (`environment`, `group`, `namespace`, `item`, `value`) VALUES
('*', 'config', 'platform/users', 'registration', 'false'),
('*', 'config', 'platform/users', 'activation', '"admin"'),
('*', 'workbench', NULL, 'name', '"Fong Her"'),
('*', 'workbench', NULL, 'email', '"fongher@gmail.com"'),
('*', 'config', 'cartalyst/workshop', 'vendor', '"onsitect"'),
('*', 'themes', 'platform/admin', 'active', '"admin::default"'),
('*', 'config', 'cartalyst/themes', 'active', '"frontend::default"'),
('*', 'config', 'cartalyst/themes', 'debug', 'true'),
('*', 'config', 'cartalyst/themes', 'force_recompile', 'true'),
('*', 'config', 'cartalyst/themes', 'auto_clear', 'true');
...
INSERT INTO `content` (`id`, `name`, `slug`, `type`, `value`, `file`, `enabled`, `created_at`, `updated_at`) VALUES
(1, 'Synopsis', 'synopsis', 'filesystem', NULL, 'synopsis.md', 1, '2014-05-03 00:09:30', '2014-05-03 00:09:30'),
(2, 'Package Driven', 'packages', 'filesystem', NULL, 'featurettes/packages.md', 1, '2014-05-03 00:09:30', '2014-05-03 00:09:30'),
(3, 'Extension Based', 'extensions', 'filesystem', NULL, 'featurettes/extensions.md', 1, '2014-05-03 00:09:30', '2014-05-03 00:09:30'),
(4, 'Theme Ready', 'themes', 'filesystem', NULL, 'featurettes/themes.md', 1, '2014-05-03 00:09:30', '2014-05-03 00:09:30');
...
CREATE TABLE IF NOT EXISTS `districts` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `supplemental` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `isactive` tinyint(4) NOT NULL DEFAULT '1',
  `doccode` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `districts` (`id`, `name`, `supplemental`, `attention`, `title`, `address`, `address2`, `city`, `state`, `zipcode`, `phone`, `comment`, `website`, `district_id`, `created_at`, `updated_at`, `deleted_at`, `isactive`, `doccode`) VALUES
(1, 'Central Unified School District', '', 'ATTN: Jamie Russell', 'Administrator of Special Education & Support Services', '4605 N. Polk', '', 'Fresno', 'CA', '93722', '559-274-4700', '', '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, ''),
(2, 'Coalinga-Huron JUSD', '', 'ATTN: Kim Greve', 'Director of Special Education', 'Distrct Office', '657 Sunset Street', 'Coalinga', 'CA', '93210', '559-935-7500', '', '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
(3, 'County of Fresno', '', 'ATTN: MTP, Mary Lewis', 'Rehab Therapy Manager', 'P.O. Box 11867', '', 'Fresno', 'CA', '93775', '559-600-6540', '', '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
(4, 'County of Tulare', NULL, 'ATTN: Valerie Melton', 'Purchasing Department', '221 S. Mooney Blvd. Room 3', NULL, 'Visalia', 'CA', '93291', '559-624-8085', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(5, 'Cutler-Orosi JUSD', '', 'ATTN: Gary Sanchez', 'Director of Special Education', '12623 Avenue 416', '', 'Orosi', 'CA', '93647-2017', '559-528-4763', '', '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
(6, 'Dinuba Unified School District', NULL, 'ATTN: Joe Martinez', 'Director of Special Student Services', '1327 E. El Monte Way', NULL, 'Dinuba', 'CA', '93618', '559-595-720', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(7, 'Firebaugh-Las Deltas USD', NULL, 'ATTN: Roy Mendiola', 'Superintendent', 'Accounts Payables', '1976 Morris Kyle Dr.', 'Firebaugh', 'CA', '93622', '559-659-1476', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(8, 'Fowler Unified School District', NULL, 'ATTN: Scott Griffin', 'Special Education Director', '658 E. Adams Ave.', NULL, 'Fowler', 'CA', '93625', '559-834-6080', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(9, 'Fresno County Office of Education', NULL, 'ATTN: Eddie Davidson', 'Deborah Davis, Program Manager', '1111 Van Ness, 6th Floor Towers', NULL, 'Fresno', 'CA', '93721', '559-497-3907', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(10, 'Fresno Unified School District', NULL, 'ATTN: Shoushan Krikorian', 'Accounts Payable', '3132 E. Fairmont Ave. Bldg. 1', 'ATP at IMC', 'Fresno', 'CA', '93726', '559-248-7153', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(11, 'Golden Plains Unified School District', NULL, 'ATTN: Evelyn Diaz', 'Special Education Coordinator', 'P. O. Box 937', NULL, 'San Joaquin', 'CA', '93660', '559-693-1115', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(12, 'Greenfield Union School District', NULL, 'ATTN: Nancy Hogge', 'Special Education Director', '493 El Camino Real', NULL, 'Greenfield', 'CA', '93927', '831-674-2840', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(13, 'Kerman Unified School District', '', 'ATTN: Finance Department', 'Rita Farabaugh, Coordinator of Pupil Personnel Services', '151 S. First Street', '', 'Kerman', 'CA', '93630', '559-842-2161', '', '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
(14, 'Kern County Superintendent of Schools', NULL, 'ATTN: Wesley Neal', '', '1300 Seventeenth Street', NULL, 'Bakersfield', 'CA', '93301-4533', '661-636-4524', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(15, 'Kings County Office of Education', NULL, 'ATTN: Natalie Harlan', 'Special Education Director', '1144 W. Lacey Blvd.', NULL, 'Hanford', 'CA', '93230', '559-589-2504', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(16, 'Laton Unified School District', NULL, 'ATTN: Reatha Martinez', 'Director of Finance', 'P.O. Box 248', '6259 E. De Woody', 'Laton', 'CA', '93242', '559-922-4015', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(17, 'Lindsay Unified School District', NULL, 'ATTN: Suzzane Terrill', 'Special Education Director', '371 E. Hermosa ', NULL, 'Lindsay', 'CA', '93247', '559-562-5111', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(18, 'Madera County Public Health Dept.', NULL, 'ATTN: Maria Solorio', 'Administrative Analyst II', '14215 Road 28', NULL, 'Madera', 'CA', '93638', '559-675-7893', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(19, 'Mendota Unified School District', NULL, 'ATTN: Rod Smith', 'Special Education Director', '115 McCabe Ave', NULL, 'Mendota', 'CA', '93640', '559-655-4942', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(20, 'Pacific Grove Unified School District', NULL, 'ATTN: Cindy Gallo', 'Director of Student Services', '435 Hillcrest Ave', NULL, 'Pacific Grove', 'CA', '93950', '831-646-6523', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(21, 'Parlier Unified School District', NULL, 'ATTN: Antonio Aguilar', 'Director of Student Support Services', '900 Newmark Ave', NULL, 'Parlier', 'CA', '93648', '559-646-2731', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(22, 'Raisin City Elementary School District', NULL, 'ATTN: Jacqueline Hightower, Accounts Payable', 'Juan Sandoval Superintendent', 'P.O. Box 69', '6425 W. Bowles ', 'Raisin City', 'CA', '93652', '559-233-0128', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(23, 'Riverdale Joint Unified School District', NULL, 'ATTN: Jeff Percell', 'Assistant Superintendent of Educational Services', 'P.O. Box 1058', '3160 W. Mt. Whitney Ave.', 'Riverdale', 'CA', '93656', '559-891-4300', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(24, 'Salinas City Elementary School District ', NULL, 'ATTN: Terri Dye', 'Interim Director of Pupil Personel', '840 South Main Street', NULL, 'Salinas', 'CA', '93901', '831-753-5600', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(25, 'Sanger Unified School District', NULL, 'ATTN: Kimberly Salomonson', 'Director of Pupil Personel Services', '1905 Seventh St', NULL, 'Sanger', 'CA', '93657', '559-524-6571', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(26, 'Selma Unified School District', NULL, 'ATTN: Teresa Wood', 'Director of Special Education', '3036 Thompson Avenue', NULL, 'Selma', 'CA', '93662', '559-898-6500', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(27, 'Sierra Unified School District', NULL, 'ATTN: Teresa Page', 'Director: Educational Srvcs & Spcl Prgs', '29143 Auberry Road', NULL, 'Prather', 'CA', '93651', '559-855-3662', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(28, 'So Monterey County Joint Union High SD', NULL, 'ATTN: Mike Onderko', 'Director of Special Education', '800 Broadway', NULL, 'King City', 'CA', '93930', '831-385-0606', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(29, 'Soledad Unified School District', NULL, 'ATTN: Lorelei Morones', 'Program Coordinator', 'P.O. Box 186', NULL, 'Soledad', 'CA', '93960', '831-678-1495', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(30, 'Tulare City School District', NULL, 'ATTN: Jennifer Marroquin', 'Preschool/Special Education Coordinator', '600 N. Cherry Street', NULL, 'Tulare', 'CA', '93274', '559-685-7200', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(31, 'Tulare COE', NULL, 'ATTN: Tammy Bradford', 'John Rodriguez, Director', 'P.O. Box 5091', NULL, 'Visalia', 'CA', '93278', '559-733-6306', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(32, 'Visalia Unified School District', NULL, 'ATTN: Cara Peterson', 'Director of Special Education', '5000 W. Cypress Ave.', NULL, 'Visalia', 'CA', '93277', '559-730-7300', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(33, 'Washington Colony School District', NULL, 'ATTN: Accounts Payable', 'Craig Bowden, Superintendent', '130 East Lincoln Ave', NULL, 'Fresno', 'CA', '93706', '559-233-0706', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(34, 'Washington Unified School District', NULL, 'ATTN: Heather Gomez', 'Director of Educational Support', '6041 S. Elm Ave.', NULL, 'Fresno', 'CA', '93706', '559-495-5609', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(35, 'Washington Union School District', NULL, 'ATTN: Carissa Edeza', 'Principal', '43 San Banancio Road', NULL, 'Salinas', 'CA', '93908', '831-484-9691', NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(36, 'Westside Elementary School District', NULL, 'ATTN: Baldomero Hernandez', 'Superintendent', 'P.O. Box 398', '19191 W. Excelsior', 'Five Points', 'CA', '93624', NULL, NULL, NULL, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(37, 'Caruthers Unified School District', '', 'ATTN: Orin Hirschkorn', 'Superintendent', 'P.O. Box 127', '1 Tiller Ave', 'Caruthers', 'CA', '93609', '559-495-6400', '', '', NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
(38, 'Test', '', 'J Rusk', 'IT', '1234 Main', '', 'Fresno', 'CA', '93700', '', '', '', NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
(39, 'Dist D', '', 'Susie S.', 'Boss Lady', '133', '', 'fresno', 'CA', '93720', '5592138584', '', '', NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, '');
...
INSERT INTO `extensions` (`slug`, `version`, `enabled`) VALUES
('onsitect/goodfellow', '1.0.0', 1),
('platform/admin', '2.0.0', 1),
('platform/attributes', '1.0.0', 1),
('platform/content', '2.0.0', 1),
('platform/media', '2.0.0', 1),
('platform/menus', '2.0.0', 1),
('platform/operations', '2.0.0', 1),
('platform/pages', '2.0.0', 1),
('platform/settings', '2.0.0', 1),
('platform/users', '2.0.0', 1);
...
INSERT INTO `groups` (`id`, `slug`, `name`, `permissions`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'Admin', '{"admin":true}', '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(2, 'ceo', 'CEO', '{"admin":true,"Platform\\\\Admin\\\\Controllers\\\\Admin\\\\AdminController@index":true}', '2014-05-10 00:10:34', '2014-05-10 00:10:34'),
(3, 'therapist', 'Therapist', '{"Platform\\\\Admin\\\\Controllers\\\\Admin\\\\AdminController@index":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\district@index":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\school@index":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\student@create":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\student@copy":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\student@edit":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\student@delete":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\therapist@index":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\therapist@edit":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\treatment@index":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\treatment@create":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\treatment@copy":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\treatment@edit":true,"Onsitect\\\\Goodfellow\\\\Controllers\\\\Admin\\\\GoodfellowController\\\\treatment@delete":true,"Platform\\\\Attributes\\\\Controllers\\\\Admin\\\\AttributesController@index,grid":true,"Platform\\\\Menus\\\\Controllers\\\\Admin\\\\MenusController@index,grid":true}', '2014-05-10 00:12:12', '2014-05-10 00:18:34'),
(4, 'billing', 'Billing', '{"admin":true}', '2014-05-10 00:14:12', '2014-05-10 00:14:12');
...
(1, 1, '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(2, 3, '2014-05-10 00:15:25', '2014-05-10 00:15:25');
...
CREATE TABLE IF NOT EXISTS `keys` (
  ...
  `name` date NOT NULL,
  `isactive` tinyint(4) NOT NULL DEFAULT '1',
  `chargeperhour` decimal(10,2) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `menus` (`id`, `slug`, `lft`, `rgt`, `menu`, `extension`, `name`, `type`, `page_id`, `secure`, `uri`, `class`, `target`, `visibility`, `groups`, `regex`, `enabled`, `created_at`, `updated_at`) VALUES
(1, 'admin', 1, 40, 1, NULL, 'Admin', 'static', NULL, 0, NULL, NULL, 'self', 'always', NULL, NULL, 1, '2014-05-03 00:09:31', '2014-05-10 00:58:06'),
(2, 'admin-attributes', 6, 7, 1, 'platform/attributes', 'Attributes', 'static', NULL, 0, 'attributes', 'fa fa-asterisk', 'self', 'always', '', '/admin\\/attributes/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(3, 'admin-media', 22, 23, 1, 'platform/media', 'Media', 'static', NULL, 0, 'media', 'fa fa-picture-o', 'self', 'always', '', '/admin\\/media/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(4, 'admin-menus', 8, 9, 1, 'platform/menus', 'Menus', 'static', NULL, 0, 'menus', 'fa fa-th-list', 'self', 'always', '', '/admin\\/menus/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(5, 'system', 1, 8, 2, NULL, 'System', 'static', NULL, 0, NULL, NULL, 'self', 'always', NULL, NULL, 1, '2014-05-03 00:09:32', '2014-05-03 00:09:33'),
(6, 'system-preview', 2, 3, 2, 'platform/menus', 'Preview', 'static', NULL, 0, '/', 'fa fa-home', '_blank', 'always', '', NULL, 1, '2014-05-03 00:09:32', '2014-05-03 00:09:33'),
(7, 'system-settings', 4, 5, 2, 'platform/menus', 'Settings', 'static', NULL, 0, 'admin/settings', 'fa fa-cog', 'self', 'always', '', '/admin\\/settings/i', 1, '2014-05-03 00:09:32', '2014-05-03 00:09:33'),
(8, 'system-logout', 6, 7, 2, 'platform/menus', 'Sign Out', 'static', NULL, 0, 'logout', 'fa fa-sign-out', 'self', 'always', '', NULL, 1, '2014-05-03 00:09:32', '2014-05-03 00:09:33'),
(9, 'main', 1, 12, 3, NULL, 'Main', 'static', NULL, 0, NULL, NULL, 'self', 'always', NULL, NULL, 1, '2014-05-03 00:09:32', '2014-05-10 00:17:33'),
(10, 'main-home', 2, 3, 3, 'platform/menus', 'Home', 'static', NULL, 0, '/', 'fa fa-home', 'self', 'always', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:17:33'),
(11, 'main-dashboard', 4, 5, 3, 'platform/menus', 'Admin', 'static', NULL, 0, 'admin', 'fa fa-dashboard', 'self', 'admin', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:17:33'),
(12, 'main-login', 6, 7, 3, 'platform/menus', 'Sign In', 'static', NULL, 0, 'login', 'fa fa-sign-in', 'self', 'logged_out', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:17:33'),
(13, 'main-logout', 8, 9, 3, 'platform/menus', 'Logout', 'static', NULL, 0, 'logout', 'fa fa-home', 'self', 'logged_in', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:17:33'),
(14, 'main-register', 10, 11, 3, 'platform/menus', 'Register', 'static', NULL, 0, 'register', 'fa fa-pencil', 'self', 'logged_out', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:17:33'),
(15, 'admin-content', 4, 5, 1, 'platform/content', 'Content', 'static', NULL, 0, 'content', 'fa fa-briefcase', 'self', 'always', '', '/admin\\/content/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(16, 'admin-users', 16, 21, 1, 'platform/users', 'Users', 'static', NULL, 0, 'users', 'fa fa-user', 'self', 'always', '', '/admin\\/users/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(17, 'admin-users-users', 17, 18, 1, 'platform/users', 'Users', 'static', NULL, 0, 'users', 'fa fa-user', 'self', 'always', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(18, 'admin-users-groups', 19, 20, 1, 'platform/users', 'Groups', 'static', NULL, 0, 'users/groups', 'fa fa-group', 'self', 'always', '', '', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(19, 'admin-operations', 10, 15, 1, 'platform/operations', 'Operations', 'static', NULL, 0, 'operations', 'fa fa-rocket', 'self', 'always', '', '/admin\\/operations/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(20, 'admin-operations-extensions', 11, 12, 1, 'platform/operations', 'Extensions', 'static', NULL, 0, 'operations/extensions', 'fa fa-fighter-jet', 'self', 'always', '', '/admin\\/operations\\/extensions/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(21, 'admin-operations-workshop', 13, 14, 1, 'platform/operations', 'Workshop', 'static', NULL, 0, 'operations/workshop', 'fa fa-magic', 'self', 'always', '', '/admin\\/operations\\/workshop/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(22, 'admin-pages', 2, 3, 1, 'platform/pages', 'Pages', 'static', NULL, 0, 'pages', 'fa fa-file', 'self', 'always', '', '/admin\\/pages/i', 1, '2014-05-03 00:09:32', '2014-05-10 00:58:06'),
(26, 'admin-organization', 24, 29, 1, NULL, 'Organization', 'static', NULL, 0, 'organization', '', 'self', 'always', '', '', 1, '2014-05-04 04:27:21', '2014-05-10 00:58:06'),
(27, 'admin-district', 25, 26, 1, NULL, 'District', 'static', NULL, 0, 'district', '', 'self', 'always', '', '', 1, '2014-05-09 23:41:43', '2014-05-10 00:58:06'),
(28, 'admin-schools', 27, 28, 1, NULL, 'School', 'static', NULL, 0, 'schools', '', 'self', 'always', '', '', 1, '2014-05-09 23:41:43', '2014-05-10 00:58:06'),
(29, 'admin-student', 30, 37, 1, NULL, 'Student', 'static', NULL, 0, 'student', '', 'self', 'always', '', '', 1, '2014-05-09 23:48:53', '2014-05-10 00:58:06'),
(30, 'admin-student-information', 31, 32, 1, NULL, 'Student Information', 'static', NULL, 0, 'student', '', 'self', 'always', '', '', 1, '2014-05-09 23:48:53', '2014-05-10 00:58:06'),
(31, 'admin-direct-treatment', 33, 34, 1, NULL, 'Direct Treatment', 'static', NULL, 0, 'directtreatment', '', 'self', 'always', '', '', 1, '2014-05-09 23:48:53', '2014-05-10 00:58:06'),
(32, 'admin-indirect-treatment', 35, 36, 1, NULL, 'Indirect Treatment', 'static', NULL, 0, 'indirecttreatment', '', 'self', 'always', '', '', 1, '2014-05-09 23:48:53', '2014-05-10 00:58:06'),
(33, 'admin-billing', 38, 39, 1, NULL, 'Billing', 'static', NULL, 0, 'billing', '', 'self', 'always', '', '', 1, '2014-05-09 23:52:34', '2014-05-10 00:58:06');
...
('2013_11_26_014954_migration_cartalyst_sentry_install_activations', 2),
('2013_11_26_022418_migration_cartalyst_sentry_install_reminders', 2),
('2013_11_26_023520_migration_cartalyst_sentry_alter_users', 2),
('2013_11_26_023945_migration_cartalyst_sentry_rename_alter_groups', 2),
('2013_11_26_024557_migration_cartalyst_sentry_rename_alter_groups_users_pivot', 2),
('2013_11_26_025024_migration_cartalyst_sentry_alter_throttle', 2),
...
('2014_03_07_025421_migration_platform_content_create_table', 7),
('2012_12_19_034250_migration_platform_users_install_sentry_social', 8),
('2014_03_13_040514_migration_platform_pages_create_table', 9),
('2014_03_13_040635_migration_platform_pages_update_menus_table', 9);
...
INSERT INTO `pages` (`id`, `name`, `slug`, `uri`, `type`, `visibility`, `groups`, `template`, `section`, `value`, `file`, `enabled`, `created_at`, `updated_at`) VALUES
(1, 'Welcome', 'welcome', '/', 'filesystem', 'always', NULL, NULL, NULL, NULL, 'welcome', 1, '2014-05-03 00:09:31', '2014-05-03 00:09:31'),
(2, 'TEsting', 'testing', 'testing', 'database', 'always', NULL, 'layouts/default', 'content', '<p>testing to make sure</p>', NULL, 1, '2014-05-03 00:50:26', '2014-05-03 00:50:26');
...
(1, 1, '2014-06-03 06:29:59', 'protected', 'admin', 'admin', 1, 1, 'webmaster@example.com', NULL, NULL, NULL),
(2, 2, '2014-06-03 06:29:59', 'protected', 'demo', 'demo', 1, 1, 'demo@example.com', NULL, NULL, NULL),
(3, 3, '0000-00-00 00:00:00', 'protected', 'Her', 'Fong', 1, 1, 'fongher@gmail.com', '', '', ''),
(4, 4, '0000-00-00 00:00:00', 'protected', 'Rusk', 'John', 1, 1, 'john@civtech.net', '', '', '');
...
(1, 3, 1404790557, 1405105349, 2),
(1, 4, 1404790621, 1405105366, 2);
...
(5, 'CEO', 'ceo of the company', NULL, NULL, NULL),
(6, 'therapist', '', NULL, NULL, NULL),
(7, 'Billing', '', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `schools` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `eddirector` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `isactive` tinyint(4) NOT NULL DEFAULT '1',
  `doccode` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `schools` (`id`, `eddirector`, `title`, `name`, `address`, `city`, `state`, `zipcode`, `phone`, `fax`, `website`, `district_id`, `created_at`, `updated_at`, `deleted_at`, `isactive`, `doccode`) VALUES
(2, 'Orin Hirschkorn', 'Superintendent', 'Caruthers High School ', '', '', '', '', '', '', '', 37, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D '),
(3, 'Orin Hirschkorn', 'Superintendent', 'MARC High School', '', '', '', '', NULL, NULL, NULL, 37, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D '),
(6, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'C.L.A.S.S.', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(7, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Central East High School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(8, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Central West High School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(9, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'El Capitan Middle School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(10, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Glacier Point Middle School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(11, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Harvest Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(12, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Herndon-Barstow Elementary', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(13, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Houghton-Kearney K-8 School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(14, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Liddell Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(15, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Madison Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(16, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'McKinley Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(17, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Pathway Community Day School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(18, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Pershing Continuation High School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(19, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Polk Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(20, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Rio Vista Middle School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(21, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'River Bluff Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(22, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Roosevelt Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(23, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Saroyan Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(24, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Steinbeck Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(25, 'Jamie Russell', 'Administrator of Special Education & Support Services', 'Teague Elementary School', '', '', '', '', NULL, NULL, NULL, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(26, 'Tony Rodriguez', 'Site Director', 'Bishop Elementary School', '', '', '', '', '', '', '', 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(27, 'Tony Rodriguez', 'Site Director', 'Dawson Elementary School', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(28, 'Tony Rodriguez', 'Site Director', 'Sunset Elementary School', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(29, 'Tony Rodriguez', 'Site Director', 'West Hills Preschool', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(30, 'Tony Rodriguez', 'Site Director', 'Coalinga Middle School', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(31, 'Tony Rodriguez', 'Site Director', 'Cheney Elementary School', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(32, 'Tony Rodriguez', 'Site Director', 'Huron Elementary School', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(33, 'Tony Rodriguez', 'Site Director', 'West Hills - Huron', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(34, 'Tony Rodriguez', 'Site Director', 'Head Start Huron', '', '', '', '', NULL, NULL, NULL, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, 'D'),
(35, '', '', 'Test School', '123 Main', '', '', '', '', '', '', 38, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, ''),
(36, '', '', 'Test School', '', '', '', '', '', '', '', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1, '');
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  `subtherapist_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `isactive` tinyint(4) NOT NULL DEFAULT '1',
...
INSERT INTO `students` (`id`, `email`, `fname`, `lname`, `grade`, `dob`, `school_id`, `therapist_id`, `subtherapist_id`, `created_at`, `updated_at`, `deleted_at`, `isactive`) VALUES
(1, 'bob@bob.net', 'Bob', 'Smith', 5, '2000-01-01', 38, 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 1);
...
(1, 0, 'global', NULL, '2014-05-10 00:19:26', '2014-05-10 00:19:26'),
(2, 0, 'ip', '127.0.0.1', '2014-05-10 00:19:26', '2014-05-10 00:19:26'),
(3, 2, 'user', NULL, '2014-05-10 00:19:26', '2014-05-10 00:19:26');
...
--
-- Table structure for table `treatmentdirects`
--

CREATE TABLE IF NOT EXISTS `treatmentdirects` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `duration` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `key_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `treatmentdate` date NOT NULL,
  `otservice` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `iepdueon` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `gmp_sittingposture` tinyint(4) NOT NULL DEFAULT '0',
  `gmp_standing` tinyint(4) NOT NULL DEFAULT '0',
  `gmp_shoulder` tinyint(4) NOT NULL DEFAULT '0',
  `gmp_trunk` tinyint(4) NOT NULL DEFAULT '0',
  `gmp_rangemotion` tinyint(4) NOT NULL DEFAULT '0',
  `gmp_ndt` tinyint(4) NOT NULL DEFAULT '0',
  `fvm_grasping` tinyint(4) NOT NULL DEFAULT '0',
  `fvm_handstrength` tinyint(4) NOT NULL DEFAULT '0',
  `fvm_coloring` tinyint(4) NOT NULL DEFAULT '0',
  `fvm_scissor` tinyint(4) NOT NULL DEFAULT '0',
  `fvm_bilateral` tinyint(4) NOT NULL DEFAULT '0',
  `fvm_crossing` tinyint(4) NOT NULL DEFAULT '0',
  `sck_feeding` tinyint(4) NOT NULL DEFAULT '0',
  `sck_fastener` tinyint(4) NOT NULL DEFAULT '0',
  `sck_management` tinyint(4) NOT NULL DEFAULT '0',
  `ss_tactile` tinyint(4) NOT NULL DEFAULT '0',
  `ss_visual` tinyint(4) NOT NULL DEFAULT '0',
  `ss_vestibular` tinyint(4) NOT NULL DEFAULT '0',
  `ss_proprioceptive` tinyint(4) NOT NULL DEFAULT '0',
  `ss_motorplanning` tinyint(4) NOT NULL DEFAULT '0',
  `ss_alertprogram` tinyint(4) NOT NULL DEFAULT '0',
  `ss_attention` tinyint(4) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `treatmentindirects`
--

CREATE TABLE IF NOT EXISTS `treatmentindirects` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `travel_duration` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `setup_duration` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `treatmentdate` date NOT NULL,
  `documentation_duration` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `other_duration` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `therapist_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
...
(1, 'admin', 'd7a2a2e41824b21497964c9086656e4fd630b3a0e048f227a28b8c37a6313f7521219b3b1ff813795604a1719f9fa58fbb0ee16a8b30af07ce97e7d17a9bba31', '7PbEEaeixOVf/NibMWJjSSOLi568Yci0viHOgahdr3uV2ac6dDljPG+IsGQBDzVs43Wuj2vmYXDCZhi4RpoOAA==', '', 1401776999, 1409514656, 1409514912, 0, 1, 1, NULL, 'Instant'),
(2, 'demo', 'afb1f78eef4917825b2863ef9ac94de84ddc36a12c60c681f83b17d3f2f2e52c694b516ad6d4bb44f3681c8cd90229ad552b6d989f826bea5afc11a1714f83b3', '0ZVOVHCbvRZVSRwAPghKdUeDun1nY7XO3dR7Wh514JY6VrxFqNMHXFoSFrXFvggcmuE6gfI1HaA07HqcXAcugQ==', '', 1401776999, 1404863460, 1402062176, 0, 0, 1, NULL, 'Instant'),
(3, 'fongher', '90b830f3de1a2ad5cdac108792c97f04cb9b5710f6551f38da9072e2959de34d0032fa2d3ac027af1059f61a12b6fa412f392eca54aa226036815dfcc54198e0', 'PYPpJr3f/nunSuxPmr5BOFiZF1pTXqZ/aCm2ARD9d0fjxPPAfYOhYl9epmb8Gmhms+LPmv4RmUTk2RxtEyTQ9A==', 'baf7a32b588f603685624345045ff2edb23b42239632119ecb2700438c0b259b7d8e64107417a98ab9306659b7b9cef6f812b8a2d4c9b01b77c7c2017c99ac8b', 1401777536, 1401777697, 0, 1401777536, 1, 1, NULL, 'Instant'),
(4, 'johnr', 'c708d6691d95019b08818150550f4a3ece5b9575a7576ea392bd710832f4041beb62ab6db463bbb1a51e41cc6a802cf14d5155748ce8897db14523da940a3b43', 'bfNA7hqqxr+x4QEuHofiDcOtPOchsyiqMBryxuJpbQDP8y0whYqne5qpFYpjKzirlMzZMphtYNjN6ixFkUbiWg==', '14d35b0f1d23a6d38113f3e2c7a187eea34a3203e165d52950277ad4303d149eb9bfdfb0f68058e30f727ac530ed5fee86768d728cee1d39625655c48037e8f2', 1404752617, 1405105498, 0, 1404752617, 1, 1, NULL, 'Instant');
