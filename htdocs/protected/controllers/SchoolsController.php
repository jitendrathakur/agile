...
class SchoolsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'dynamicschools'),
				'users'=>array('*'),
			),
    ...
    public function actionDynamicschools()
    {
        $data=Schools::model()->findAll('district_id=:district_id',
            array(':district_id'=>(int) $_REQUEST['district_id']));
        ...
        if(!empty($data)){
            ...
            echo '<option value="0">No School Found</option>';
        }
