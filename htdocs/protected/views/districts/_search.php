...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'supplemental'); ?>
		<?php echo $form->textField($model,'supplemental',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'attention'); ?>
		<?php echo $form->textField($model,'attention',array('size'=>60,'maxlength'=>255)); ?>
	</div>
