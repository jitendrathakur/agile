...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'eddirector'); ?>
		<?php echo $form->textField($model,'eddirector',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'doccode'); ?>
		<?php echo $form->textField($model,'doccode',array('size'=>15,'maxlength'=>15)); ?>
	</div>
